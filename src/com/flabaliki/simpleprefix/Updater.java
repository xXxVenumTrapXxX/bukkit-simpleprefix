...
public class Updater {
     ...
     * revise this method, using the loca
     * l and remote version parameters, to execute the
     * appropriate check.
     * </p>
     * <p>
    ...
    public boolean shouldUpdate(String localVersion, String remoteVersion) {
    	...
    	String[] rVersion = remoteVersion.split("\\.");
    	if (Integer.parseInt(rVersion[0]) > Integer.parseInt(lVersion[0])) return true;
    	else if (Integer.parseInt(rVersion[0]) < Integer.parseInt(lVersion[0])) return false;
    	if (Integer.parseInt(rVersion[1]) > Integer.parseInt(lVersion[1])) return true;
    	else if (Integer.parseInt(rVersion[1]) < Integer.parseInt(lVersion[1])) return false;
    	if (Integer.parseInt(rVersion[2]) > Integer.parseInt(lVersion[2])) return true;
    	else if (Integer.parseInt(rVersion[2]) < Integer.parseInt(lVersion[2])) return false;
    	// I added the else statements above because dev builds were being down-graded
        return false;
    }
